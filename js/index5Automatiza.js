...
//----------------------------------------------------
//Criação da aula (automação)
//Adiciona um evento de click ao botão
document.getElementById('clonarAulaGabarito').addEventListener('click', function () {
    //Seleciona o elemento gabaritoOriginal
    const gabaritoOriginal = document.querySelector('.aula#gabarito');
    //Cria um clone do elemento
    const clone = gabaritoOriginal.cloneNode(true);
    //Remove o id do clone para deixá-lo vazio
    clone.removeAttribute('id');
    //Insere o clone logo acima do gabarito original
    gabaritoOriginal.parentNode.insertBefore(clone, gabaritoOriginal);

    //Salva no arquivo HTML
    fetch(' /clonar', { method: 'POST' })
